...
public class ViewController: UIViewController, SFSpeechRecognizerDelegate {
    ...
    let destIP = "169.254.185.174"
    let destPort: UInt16 = 54327
    var fd: Int32 = 0
    ...
    private func startRecording() throws {
        ...
        recognitionRequest.contextualStrings = ["Bee Dee Two", "Judy", "meow"]
            ...
            if let result = result {
                ...
                if !isFinal {  // happens when listening stopped
                    ...
                    if (send) {
                        ...
                        self.udpSend(textToSend: self.udpDescription(id: self.utteranceID, transcription: result.bestTranscription.formattedString))
